...
from .views import HomeView, ArtikelDetail, AddPostView, PostUpdateView, PostDeleteView, AddCategoryView, CategoryView, CategoryListView
...
urlpatterns = [
    ...
    path('category_list/', CategoryListView, name='list-kategori'),
    ]